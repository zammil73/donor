...
<body>
					...
					<div class="tab" role="tabpanel">
						<form class="tab-content tabs" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
							<div role="tabpanel" class="tab-pane active" id="Section1">
								...
								<p>Blood Donation is a complete solution for searching Blood Donors according to location and Blood Group. This CMS Includes almost everything you need to find the right Blood Donor. Blood Donation is fully responsive for any device.</p>
								<ul class="nav justify-content-center">
									<li class="nav-item">
										<a href="#Section2" class="nav-link btn btn-success btnNext" data-toggle="tab" role="tab">Next</a>
									</li>
								</ul>
							</div>
							<div role="tabpanel" class="tab-pane" id="Section2">
								...
								<ul class="nav justify-content-center">
									<li class="nav-item">
										<a href="#Section1" class="nav-link btn btn-success btnPrev mr-2" data-toggle="tab" role="tab">Previous</a>
									</li>
									<li class="nav-item">
										<a href="#Section3" class="nav-link btn btn-success btnNext" data-toggle="tab" role="tab">Next</a>
									</li>
								</ul>
							</div>
							<div role="tabpanel" class="tab-pane" id="Section3">
								...
								<ul class="nav justify-content-center">
									<li class="nav-item">
										<a href="#Section2" class="nav-link btn btn-success mr-2" data-toggle="tab" role="tab">Previous</a>
									</li>
									<li class="nav-item">
										<input type="submit" name="install" class="nav-link btn btn-success" value="Install" />
									</li>
								</ul>
						...
						if (isset($_POST['install'])) {
							if (!isset($_POST['host']) || $_POST['host'] == '') {
								...
								if (mysqli_connect_error()) {
									...
									copy("install.inc.php", "../admin/php_files/database.php");
									$file = "../admin/php_files/database.php";
									...
									include '../admin/php_files/config.php';
									$db = new Database();
									$db->update('admin', array('username' => $username, 'password' => $password), "admin_id=1");
									$res1 = $db->getResult();
	...
	<script>
		...
		$('.btnNext').click(function() {
			...
			$(this).parent().parents().next('.tab-pane').addClass('active');
		});

		$('.btnPrev').click(function() {
			$(this).parent().parents().removeClass('active');
			$(this).parent().parents().prev('.tab-pane').addClass('active');
		});
	</script>
</body>
